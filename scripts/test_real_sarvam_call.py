"""
Fleetos Real Sarvam Multilingual Voice Agent Call Script
Module Boundary: scripts/test_real_sarvam_call.py
"""
...
def main():
    print("=== FLEETOS REAL SARVAM MULTILINGUAL VOICE AGENT DISPATCH TEST ===")
    ...
    print("\nDispatching Sarvam Multilingual ATLAS call for Driver D03 (Lorry L03)...")
    try:
        ...
        print("External ID / SID:", rec.get("external_call_id"))
    except Exception as err:
